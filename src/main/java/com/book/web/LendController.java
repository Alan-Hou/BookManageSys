...
public class LendController {
    ...
    @RequestMapping("/delsernum.html")
    public String delSernum(HttpServletRequest request,RedirectAttributes redirectAttributes)
    {
        long sernum=Integer.parseInt(request.getParameter("sernum"));
        int res=lendService.delSernum(sernum);
        if(res==1)
        {
